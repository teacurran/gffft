...
class _AnyLinkPreviewState extends State<AnyLinkPreview> {
  ...
  Widget build(BuildContext context) {
    ...
    var _height = (widget.displayDirection == UIDirection.UIDirectionHorizontal || !widget.showMultimedia)
    ...
    if (_loading)
      return (!_linkValid || !_proxyValid) ? _loadingErrorWidget : (widget.placeholderWidget ?? _loadingErrorWidget);
    ...
    return _info == null
        ...
        : _buildLinkContainer(
            ...
            image: LinkAnalyzer.isNotEmpty(info.image) ? ((widget.proxyUrl ?? '') + (info.image ?? '')) : _errorImage,
          );
  }
}
