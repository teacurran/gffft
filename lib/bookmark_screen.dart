        ...
        PagedSliverList<String?, Bookmark>(
          ...
          builderDelegate: PagedChildBuilderDelegate<Bookmark>(
              ...
              itemBuilder: (context, bookmark, index) {
                ...
                if (membershipLine != null && membershipLine.isNotEmpty && handle != null && handle.isNotEmpty) {
                  membershipLine = membershipLine + " / " + handle;
                }

                if (gffft != null) {
                  List<Widget> children = [SelectableText(gffft.description ?? gffft.name, textAlign: TextAlign.left)];
