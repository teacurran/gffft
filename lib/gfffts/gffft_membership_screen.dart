...
class GffftMembershipScreen extends StatefulWidget {
  const GffftMembershipScreen({Key? key, required this.uid, required this.gid}) : super(key: key);

  final String uid;
  final String gid;

  @override
  State<GffftMembershipScreen> createState() => _GffftMembershipScreenState();
}

class _GffftMembershipScreenState extends State<GffftMembershipScreen> {
